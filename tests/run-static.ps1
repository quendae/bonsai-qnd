...
foreach($test in @('Profile.Tests.ps1','Resources.Tests.ps1','Harness.Tests.ps1','Setup.Tests.ps1','Doctor.Tests.ps1','Qnd.Tests.ps1','Installer.Tests.ps1','Launcher.Tests.ps1')){ & (Join-Path $Root "tests\powershell\$test") }
