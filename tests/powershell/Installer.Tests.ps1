...
foreach($needle in @('v0.1.0-pre.2','--prerelease','BonsaiQND-Setup-v0.1.0-pre.2.exe','dotnet publish','contents: write')){ if(-not $wf.Contains($needle)){ throw "prerelease workflow missing $needle" } }
